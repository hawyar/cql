...
public interface cqlListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link cqlParser#simpleLiteral}.
	 * @param ctx the parse tree
	 */
	void enterSimpleLiteral(cqlParser.SimpleLiteralContext ctx);
	/**
	 * Exit a parse tree produced by {@link cqlParser#simpleLiteral}.
	 * @param ctx the parse tree
	 */
	void exitSimpleLiteral(cqlParser.SimpleLiteralContext ctx);
	/**
