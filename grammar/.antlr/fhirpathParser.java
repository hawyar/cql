...
public class fhirpathParser extends Parser {
	...
	public static final int
		...
		T__52=53, T__53=54, DATETIME=55, TIME=56, IDENTIFIER=57, DELIMITEDIDENTIFIER=58, 
	...
	public final FunctionContext function() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2269814484132436016L) != 0)) {
				{
				setState(110);
				paramList();
				}
	...
	public final IdentifierContext identifier() throws RecognitionException {
		...
		try {
			...
			setState(146);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 432345564240156672L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
